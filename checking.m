...
%полезно для задачи навигации робота
% b
% ^
% | A(a,b)
%
...
A23 = A(a,b+1);
A33 = A(a+1,b+1);
elseif (a>=2)&(b>=2)&(a<X) % убирает b+1
A11 = A(a-1,b-1);
A21 = A(a,b-1);
A31 = A(a+1,b-1);
A12 = A(a-1,b);
A32 = A(a+1,b);
elseif (a>=2)&(a<X)&(b<Y) % убирает b-1
A12 = A(a-1,b);
A32 = A(a+1,b);
A13 = A(a-1,b+1);
A23 = A(a,b+1);
A33 = A(a+1,b+1);
elseif (a>=2)&(b>=2)&(b<Y) % убирает a+1
A11 = A(a-1,b-1);
A21 = A(a,b-1);
A12 = A(a-1,b);
A13 = A(a-1,b+1);
A23 = A(a,b+1);
elseif (b>=2)&(a<X)&(b<Y) %убирает a-1
A21 = A(a,b-1);
A31 = A(a+1,b-1);
A32 = A(a+1,b);
A23 = A(a,b+1);
